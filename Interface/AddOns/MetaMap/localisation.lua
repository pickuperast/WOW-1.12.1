...
MetaMap_Data = {
	...
	[31] = {
		...
		["LevelRange"] = "10-60",
		["PlayerLimit"] = "4-10",
		["texture"] = "Warsong Gulch",
		["infoline"] = "The Warsong clan is an orcish clan, formerly led by Grom Hellscream and now led by his son Garrosh Hellscream. The clan's Warsong Outriders form the Horde faction in the Warsong Gulch battleground — where they are attempting to defend their logging operations in Ashenvale from the Silverwing Sentinels, a faction of night elves seeking to protect their ancestral forests. Additionally, the Warsong Offensive spearheads the Horde's assault against the Scourge in Northrend. Orcs nowadays in Azeroth are also considered to be superior to others, due to their battle tactics and affection against their clans.",
	},
};
